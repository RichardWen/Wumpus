...
namespace HuntTheWumpus
{
    public class Entity
    {
        ...
        {
            int currentRoomNumber = rowNum * map.getWidth() + colNum;
            int currentDoorNumber = map.doorNum(currentRoomNumber, dir);
            Console.WriteLine(currentRoomNumber + " " + dir + " becomes " + currentDoorNumber);
            if (map.GetDoors()[rowNum, colNum, dir])
            {
